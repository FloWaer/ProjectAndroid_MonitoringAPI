...
import com.example.monprojetandroid.Model.User;
import com.example.monprojetandroid.Model.UserAccessBDD;
    ...
    public void onMainClickManager(View v) {
        switch (v.getId()) {
            ...
            case R.id.Bt_new_user:
                Intent intentUser = new Intent(this, CreateUserActivity.class);
